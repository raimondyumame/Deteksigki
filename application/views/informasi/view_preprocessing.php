			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
                        ...
                        <h5 class="sidebar-brand-text mt-5 pr-2 mb-5">Smart Home</h5>
						<!--end::Logo-->
						<!--begin::Toggle-->
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Informasi preprocessing</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
                                ...
                                <div class="d-flex align-items-center">
									<!--begin::Button-->
									<a href="<?=site_url('admin')?>" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Admin</a>
									<!--end::Button-->
									</div>
								<!--end::Toolbar-->
							</div>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Informasi preprocessing
											<span class="text-muted pt-2 font-size-sm d-block">Melihat informasi gambar yang telah di cropping</span></h3>
										</div>
