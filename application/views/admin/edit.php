                        ...
                        <div class="offcanvas-content pr-5 mr-n5">
                            ...
                            <div class="d-flex align-items-center mt-5">
                                <div class="symbol symbol-100 mr-5">
                                    <div class="symbol-label" style="background-image:url('<?php echo base_url() ?>assets/images/profile/default.jpg')"></div>
                                    <i class="symbol-badge bg-success"></i>
                                </div>
                                <div class="d-flex flex-column">
                                    <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $user['name']; ?></a>
                                    <div class="text-muted mt-1">Aplikasih Deteksi</div>
                                    <div class="navi mt-2">
                                        ...
                                        <a href="<?php echo base_url('auth') ?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
                                    </div>
                                </div>
                            </div>
                            <!--end::Header-->
                            ...
                            <div class="navi navi-spacer-x-0 p-0">
                                <!--begin::Item-->
                                <a href="<?php echo base_url('auth/registrasi') ?>" class="navi-item">
                                    <div class="navi-link">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold">Tambah Admin</div>
                                            <div class="text-muted">Account settings and more
                                                <span class="label label-light-danger label-inline font-weight-bold">add admin</span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
