<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="<?php echo base_url('admin') ?>">
            <img alt="Logo" class="w-80px" src="<?php echo base_url() ?>assets/media/logos/tes.png" />
        </a>
        <!--end::Logo-->
    </div>
    <!--end::Brand-->
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    ...
                    <ul class="menu-nav">
                        <li class="menu-item menu-item-active" aria-haspopup="true">
                            <a href="<?php echo base_url('informasi') ?>" class="menu-link">
                            ...
                            <li class="menu-item menu-item-active" aria-haspopup="true">
                            <a href="<?php echo base_url('informasi/preprocessing_view') ?>" class="menu-link">
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                        ...
                        <li class="menu-item menu-item-active" aria-haspopup="true">
                            <a href="<?php echo base_url('informasi/do_testing') ?>" class="menu-link">
  ...
  <path fill-rule="evenodd" d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5 0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964 4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2Z"/>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Capture</span>
                            ...
                            <div class="menu-submenu" kt-hidden-height="200" style="display: none; overflow: hidden;">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="<?php echo base_url('camera') ?>" class="menu-link">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="<?php echo base_url('tambah_data') ?>" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Otomatis</span>
                                        </a>
                                </ul>
                    </ul>
