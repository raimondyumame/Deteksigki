                    ...
                    <div class="offcanvas-content pr-5 mr-n5">
                        ...
                        <div class="d-flex align-items-center mt-5">
                            <div class="symbol symbol-100 mr-5">
                                <div class="symbol-label" style="background-image:url('<?= base_url('assets/images/profile/') . $user['image']; ?>')"></div>
                                <i class="symbol-badge bg-success"></i>
                            </div>
                            <div class="d-flex flex-column">
                                <a href="<?php echo base_url('admin') ?>" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $user['name']; ?></a>
                        ...
                        <div class="navi navi-spacer-x-0 p-0">
                            ...
                            <!--end:Item-->
                            <!--begin::Item-->
                            <a href="<?php echo base_url('admin/sandi') ?>" class="navi-item">
                                <div class="navi-link">
                                    <div class="symbol symbol-40 bg-light mr-3">
                                        <div class="symbol-label">
